...
**Rackspace Private Cloud v10**

Copyright © 2016 Rackspace

This documentation is intended for Rackspace Support and any other
Rackers who are adding OpenStack Object Storage (swift) to an
OpenStack-powered private cloud for a customer in a Rackspace data
center or a customer data center. The document is for informational
purposes only and is provided “AS IS.”
...
.. image:: figures/powered-by-openstack.png
   :target: http://www.openstack.org
   :alt: Powered by OpenStack

**Abstract**

This documentation provides an in-depth look at how the Rackspace Private
Cloud solution delivers a scalable and highly available environment that
provides high performance, robust security, and complete control on an open
source platform.
...
.. toctree::
   ...
   rpc-whitepaper-general.rst
   rpc-whitepaper-security.rst
   rpc-whitepaper-usecases.rst
